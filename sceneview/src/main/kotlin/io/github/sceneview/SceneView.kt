...
open class SceneView @JvmOverloads constructor(
    ...
    open val sceneLifecycle: SceneLifecycle by lazy {
        SceneLifecycle(context, this)
    }
    override fun getLifecycle() = sceneLifecycle/* ?: SceneLifecycle(context, this).also {
        _sceneLifecycle = it
    }*/
    ...
    open val camera : Camera = Camera(this)
